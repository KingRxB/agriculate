...
<section id="features" class="features">
  <div class="container">
    ...
    <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
      ...
      <div class="col-md-5">
        <img src="assets/img/features1.jpg" class="img-fluid" alt="">
      </div>
      <div class="col-md-7">
        <h3>Analisis Prediksi</h3>
        <p class="fst-italic">
        Memungkinkan pengguna untuk meramalkan situasi ketahanan pangan di masa depan dengan menggunakan data historis.
        </p>
        <ul>
          <li><i class="bi bi-check"></i> Prediksi Ketersediaan Pangan.</li>
          <li><i class="bi bi-check"></i> Fluktuasi Harga.</li>
          <li><i class="bi bi-check"></i> Perubahan Permintaan.</li>
        </ul>
      </div>
    </div><!-- Features Item -->
